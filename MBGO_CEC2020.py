...
def RunMBGO(func):
    ...
    np.savetxt("./MBGO_Data/CEC2020/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./MBGO_Data/CEC2020') == False:
        os.makedirs('./MBGO_Data/CEC2020')
    Dims = [10, 30, 50, 100]
    for Dim in Dims:
        main(Dim)
